...
3. Нажмите на коммутатор, перейдите в раздел ***CLI***.
   ...
   * пропишите ***enable***. В этом режиме можно просматривать разные конфигурации/настройки, которые задали устройству. К примеру, какие VLAN есть, на каких портах. Если это маршрутизатор, то можно посмотреть таблицу маршрутизации.
