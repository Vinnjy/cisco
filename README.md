...
+ Основная задача ***коммутатора*** и ***сетевого моста*** обеспечивать связь ***внутри локальной сети*** (передача данных от 1 устройства к другому, используя свой адрес сети (об этом чуть позже)).
