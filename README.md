...
Далее представлен формат, как данные передаются. Стрелка вниз означает инкапсуляцию данных, стрелка вверх декапсуляцию. На каждом уровне к данным добавляют служебная информация. На практике в симуляторе cisco packet tracer что происходит при передаче.
```
