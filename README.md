...
Задачка по IP-адресам и маскам решена, теперь перейдём к частным IP-адреса.
...
Мы разобрались в базовой терминологии в компьютерных сетях. Теперь перейдёи к практическим работам. Где разберём модель TCP/IP и OSI.
