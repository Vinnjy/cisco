...
Пример по IP-адресам и маскам решили.

Также стоит сказать, что не все IP-адреса используются в интернете, используются только внутри локальных сетей, их называют ***частными***:
