...
Разобрали какие устройства может использовать сеть, а теперь поговорим о её размерах и топологии. Есть много разных сетей, но здесь приведу лишь отдельные примеры для понимания.
