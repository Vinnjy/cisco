...
1. <u>**Персональная сеть**</u> - передача данных между устройствами, которые находятся рядом друг с другом. Расстояние 10-20см до пары метров.
...
> C сервером. Примеры серверов: файл-сервер, принт-сервер или сервер печати, почтовый сервер, сервер базы данных и другие - все эти типы являются хранилищами.
