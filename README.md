...
* "Промежуточные устройства" - хаб, коммутатор, маршрутизатор, и т.д.. Управляют процессов передачи данных (напраавляют, фильтруют данные), обеспечивают связь между сетями. Также обмениваются служебной информацией (к примеру, ARP (о нём чуть позже)).
